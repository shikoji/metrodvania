...
var dialog_messages: Array[String] = [
	"Ah, so it seems you where the hero sent to cure this horrid world..",
	"I thank you",
	"Now children will rest easy at night, knowing our world is free because of you..",
	"Thank you..",
	"...."
]
...
var target_scene_path: String = "res://credits/credits_scene/credits.tscn"
var progress: Array = []
